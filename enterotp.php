...
<div class="form-fild">
    <p><label>Enter your otp here <span class="required">*</span></label></p>
    <input name="otp" value="" id="otpform" type="text">
</div>

<div class="login-submit">
    <input type="submit" name="login" class="btn" id="otpbtn" value="Enter otp">
